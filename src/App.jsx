            ...
            if (profileError?.code === 'PGRST116') {
              ...
              const { error: insertError } = await supabase
                ...
                .insert({
                  ...
                  full_name: initialSession.user.user_metadata?.full_name || 'User',
                  role: initialSession.user.user_metadata?.role || 'student',
                  roll_number: initialSession.user.user_metadata?.roll_number,
                  branch: initialSession.user.user_metadata?.branch
                });
